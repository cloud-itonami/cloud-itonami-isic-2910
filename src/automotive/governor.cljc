(ns automotive.governor
  ...
  fabricated type-approval spec-basis, incomplete evidence, an out-of-
  spec vehicle, an unresolved end-of-line defect, or a double dispatch/
  certificate-issuance). The confidence/actuation gate is SOFT: it asks a
  ...
  independent layers agree that actuation is always a human call.
    ...
    4. End-of-line defect unresolved -- reported by THIS proposal itself
