# Operator Quickstart — Manufacture of Motor Vehicles

Shortest path from clone to a verified local dry-run for **ISIC 2910** (`cloud-itonami-isic-2910`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2910.git
cd cloud-itonami-isic-2910
```
...
- Blueprint governor key: `automotive-governor`
- Likely source path: `automotive.governor.cljc`
